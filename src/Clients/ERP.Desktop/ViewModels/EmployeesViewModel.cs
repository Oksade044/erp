...
public partial class EmployeesViewModel(ErpApiClient api, bool canViewSalary = true, bool createMode = false, bool canEdit = true) : ViewModelBase
{
    /// <summary>Redaktə/silmə icazəsi (hr.edit) — düymələr yalnız icazə varsa görünür.</summary>
